    ...
    <>
      <main className="relative flex h-full flex-col pt-6 px-4  sm:px-6 lg:px-8 container mx-auto">
        ...
        <div className="text-center md:text-left">
          <h1 className="text-3xl text-gray-600 font-lexend mt-10 md:mt-24">
            Guias do Codante
          </h1>
          <p className="text-gray-500 mt-2">
            Aqui você encontra todos os guias utilizados pelos nossos workshops!
            Acesse o{' '}
            <a className="text-blue-500" href="https://codante.io">
              site do Codante
            </a>
            , ou se quiser contribuir, acesse o nosso repositório no{' '}
            <a
